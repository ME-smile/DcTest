...
const double _kMinCircularProgressIndicatorSize = 54.0;
...
class DCCircularProgressIndicator extends ProgressIndicator {
  /// Creates a circular progress indicator.
  ///
  /// {@macro flutter.material.ProgressIndicator.ProgressIndicator}
  const DCCircularProgressIndicator({
    Key? key,
    double? value,
    Color? backgroundColor,
    Color? color,
  ...
  ///
  /// {@macro flutter.material.ProgressIndicator.ProgressIndicator}
  const DCCircularProgressIndicator.adaptive({
    Key? key,
    double? value,
    Color? backgroundColor,
    Animation<Color?>? valueColor,
  ...
  @override
  State<DCCircularProgressIndicator> createState() =>
      _CircularProgressIndicatorState();
}

class _CircularProgressIndicatorState extends State<DCCircularProgressIndicator>
    with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(DCCircularProgressIndicator oldWidget) {
    super.didUpdateWidget(oldWidget);
    if (widget.value == null && !_controller.isAnimating)
      _controller.repeat();
    else if (widget.value != null && _controller.isAnimating)
